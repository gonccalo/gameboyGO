...
func srl_a(op uint8) int{
	//fmt.Printf("SRL A: %X", op)
	srl(&regs.a)
	return 8
}
func srl_hl(op uint8) int{
...
func srl_l(op uint8) int{
	//fmt.Printf("SRL L: %X", op)
	srl(&regs.l)
	return 8
}
func srl_h(op uint8) int{
	//fmt.Printf("SRL H: %X", op)
	srl(&regs.h)
	return 8
}
func srl_e(op uint8) int{
	//fmt.Printf("SRL E: %X", op)
	srl(&regs.e)
	return 8
}
func srl_d(op uint8) int{
	//fmt.Printf("SRL D: %X", op)
	srl(&regs.d)
	return 8
}
func srl_c(op uint8) int{
	//fmt.Printf("SRL C: %X", op)
	srl(&regs.c)
	return 8
}
func srl_b(op uint8) int{
	//fmt.Printf("SRL B: %X", op)
	srl(&regs.b)
	return 8
}

func swap_a(op uint8) int{
	//fmt.Printf("SWAP A: %X", op)
	swap(&regs.a)
	return 8
}
func swap_hl(op uint8) int{
...
func swap_l(op uint8) int{
	//fmt.Printf("SWAP L: %X", op)
	swap(&regs.l)
	return 8
}
func swap_h(op uint8) int{
	//fmt.Printf("SWAP H: %X", op)
	swap(&regs.h)
	return 8
}
func swap_e(op uint8) int{
	//fmt.Printf("SWAP E: %X", op)
	swap(&regs.e)
	return 8
}
func swap_d(op uint8) int{
	//fmt.Printf("SWAP D: %X", op)
	swap(&regs.d)
	return 8
}
func swap_c(op uint8) int{
	//fmt.Printf("SWAP C: %X", op)
	swap(&regs.c)
	return 8
}
func swap_b(op uint8) int{
	//fmt.Printf("SWAP B: %X", op)
	swap(&regs.b)
	return 8
}

func sra_a(op uint8) int{
	//fmt.Printf("SRA A: %X", op)
	sra(&regs.a)
	return 8
}
func sra_hl(op uint8) int{
...
func sra_l(op uint8) int{
	//fmt.Printf("SRA L: %X", op)
	sra(&regs.l)
	return 8
}
func sra_h(op uint8) int{
	//fmt.Printf("SRA H: %X", op)
	sra(&regs.h)
	return 8
}
func sra_e(op uint8) int{
	//fmt.Printf("SRA E: %X", op)
	sra(&regs.e)
	return 8
}
func sra_d(op uint8) int{
	//fmt.Printf("SRA D: %X", op)
	sra(&regs.d)
	return 8
}
func sra_c(op uint8) int{
	//fmt.Printf("SRA C: %X", op)
	sra(&regs.c)
	return 8
}
func sra_b(op uint8) int{
	//fmt.Printf("SRA B: %X", op)
	sra(&regs.b)
	return 8
}

func sla_a(op uint8) int{
	//fmt.Printf("SLA A: %X", op)
	sla(&regs.a)
	return 8
}
func sla_hl(op uint8) int{
...
func sla_l(op uint8) int{
	//fmt.Printf("SLA L: %X", op)
	sla(&regs.l)
	return 8
}
func sla_h(op uint8) int{
	//fmt.Printf("SLA H: %X", op)
	sla(&regs.h)
	return 8
}
func sla_e(op uint8) int{
	//fmt.Printf("SLA E: %X", op)
	sla(&regs.e)
	return 8
}
func sla_d(op uint8) int{
	//fmt.Printf("SLA D: %X", op)
	sla(&regs.d)
	return 8
}
func sla_c(op uint8) int{
	//fmt.Printf("SLA C: %X", op)
	sla(&regs.c)
	return 8
}
func sla_b(op uint8) int{
	//fmt.Printf("SLA B: %X", op)
	sla(&regs.b)
	return 8
}

func rr_a(op uint8) int{
	//fmt.Printf("RR A: %X", op)
	rr(&regs.a)
	return 8
}
func rr_hl(op uint8) int{
...
func rr_l(op uint8) int{
	//fmt.Printf("RR L: %X", op)
	rr(&regs.l)
	return 8
}
func rr_h(op uint8) int{
	//fmt.Printf("RR H: %X", op)
	rr(&regs.h)
	return 8
}
func rr_e(op uint8) int{
	//fmt.Printf("RR E: %X", op)
	rr(&regs.e)
	return 8
}
func rr_d(op uint8) int{
	//fmt.Printf("RR D: %X", op)
	rr(&regs.d)
	return 8
}
func rr_c(op uint8) int{
	//fmt.Printf("RR C: %X", op)
	rr(&regs.c)
	return 8
}
func rr_b(op uint8) int{
	//fmt.Printf("RR B: %X", op)
	rr(&regs.b)
	return 8
}

func rl_a(op uint8) int{
	//fmt.Printf("RL A: %X", op)
	rl(&regs.a)
	return 8
}
func rl_hl(op uint8) int{
...
func rl_l(op uint8) int{
	//fmt.Printf("RL L: %X", op)
	rl(&regs.l)
	return 8
}
func rl_h(op uint8) int{
	//fmt.Printf("RL H: %X", op)
	rl(&regs.h)
	return 8
}
func rl_e(op uint8) int{
	//fmt.Printf("RL E: %X", op)
	rl(&regs.e)
	return 8
}
func rl_d(op uint8) int{
	//fmt.Printf("RL D: %X", op)
	rl(&regs.d)
	return 8
}
func rl_c(op uint8) int{
	//fmt.Printf("RL C: %X", op)
	rl(&regs.c)
	return 8
}
func rl_b(op uint8) int{
	//fmt.Printf("RL B: %X", op)
	rl(&regs.b)
	return 8
}

func rrc_a(op uint8) int{
	//fmt.Printf("RRC A: %X", op)
	rrc(&regs.a)
	return 8
}
func rrc_hl(op uint8) int{
...
func rrc_l(op uint8) int{
	//fmt.Printf("RRC L: %X", op)
	rrc(&regs.l)
	return 8
}
func rrc_h(op uint8) int{
	//fmt.Printf("RRC H: %X", op)
	rrc(&regs.h)
	return 8
}
func rrc_e(op uint8) int{
	//fmt.Printf("RRC E: %X", op)
	rrc(&regs.e)
	return 8
}
func rrc_d(op uint8) int{
	//fmt.Printf("RRC D: %X", op)
	rrc(&regs.d)
	return 8
}
func rrc_c(op uint8) int{
	//fmt.Printf("RRC C: %X", op)
	rrc(&regs.c)
	return 8
}
func rrc_b(op uint8) int{
	//fmt.Printf("RRC B: %X", op)
	rrc(&regs.b)
	return 8
}
func rlc_a(op uint8) int{
	//fmt.Printf("RLC A: %X", op)
	rlc(&regs.a)
	return 8
}
func rlc_hl(op uint8) int{
...
func rlc_l(op uint8) int{
	//fmt.Printf("RLC L: %X", op)
	rlc(&regs.l)
	return 8
}
func rlc_h(op uint8) int{
	//fmt.Printf("RLC H: %X", op)
	rlc(&regs.h)
	return 8
}
func rlc_e(op uint8) int{
	//fmt.Printf("RLC E: %X", op)
	rlc(&regs.e)
	return 8
}
func rlc_d(op uint8) int{
	//fmt.Printf("RLC D: %X", op)
	rlc(&regs.d)	
	return 8
}
func rlc_c(op uint8) int{
	//fmt.Printf("RLC C: %X", op)
	rlc(&regs.c)
	return 8
}
func rlc_b(op uint8) int{
